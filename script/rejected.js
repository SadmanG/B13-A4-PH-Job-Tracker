document.getElementById("MFC-rej").addEventListener("click", function(){
...
document.getElementById("WFA-rej").addEventListener("click", function(){
    // 1. rejected-container ke dhore niye ashbo
        const rejected = document.getElementById("rejected-container");
...
document.getElementById("DVS-rej").addEventListener("click", function(){
    // 1. rejected-container ke dhore niye ashbo
        const rejected = document.getElementById("rejected-container");
